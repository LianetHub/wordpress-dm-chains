    ...
    <div class="container">
        ...
        <div class="classes__body">
            ...
            <div class="classes__items">
                ...
                <a href="" class="classes__item">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/classes/class-B.png" alt="Фото класса А">
                </a>
                <a href="" class="classes__item">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/classes/class-C.png" alt="Фото класса А">
                </a>
            </div>
        </div>
    </div>
