...
require_once $inc_path . 'woocommerce-custom.php';
// =========================================================================
...
require_once $inc_path . 'Services/CdekService.php';
require_once $inc_path . 'Services/YandexService.php';
require_once $inc_path . 'Formatters/CdekOrderFormatter.php';
require_once $inc_path . 'Formatters/YandexOrderFormatter.php';
require_once $inc_path . 'DeliveryServiceFactory.php';
require_once $inc_path . 'MailService.php';
require_once $inc_path . 'OrderProcessor.php';
...
function configure_smtp_mailer($phpmailer)
{
	...
	if (!isset($_ENV['SMTP_HOST'])) return;
	$phpmailer->isSMTP();
